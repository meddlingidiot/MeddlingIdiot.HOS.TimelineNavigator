...
{
    [TestFixture]
    public class MoveToEndOfCurrentRestExplorerShould
    {
        ...
        public void MoveToBoTIfBeforeData()
        {
            ...
            sut.MoveToEndOfCurrentRest();
            Assert.That(sut.Start.Timestamp, Is.EqualTo(DateTime.Parse("02/14/2023 00:00:00")));
        }
        ...
        public void MoveToEotIfAfterData()
        {
            ...
            sut.MoveToEndOfCurrentRest(logger);
            //File.WriteAllText("C:\\Temp\\MoveToEndOfTimelog.txt", logger.ToString());
